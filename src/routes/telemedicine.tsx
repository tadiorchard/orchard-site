...
export const Route = createFileRoute("/telemedicine")({
  head: () => seo({
      ...
      description:
        "24/7 remote access to on-call specialists via Orchard's comprehensive telemedicine solution.",
      path: "/telemedicine",
    ...
    <main className="min-h-screen">
      ...
      <section className="gradient-hero pt-46 pb-28 lg:pt-54 lg:pb-36">
        <div className="mx-auto max-w-4xl px-6 lg:px-10 text-center">
          ...
          <h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-bold text-[var(--deep)] leading-[1.05]">Telemedicine</h1>
